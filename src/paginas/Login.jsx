...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await clienteAxios.post('/medico/login', {email, password})
  ...
  return (
    <>
          <div>
            <h1 className="text-indigo-600 font-black text-6xl">Inicia Secion y Administra {""} tus <span className="text-black">Pacientes</span></h1>
          </div>
