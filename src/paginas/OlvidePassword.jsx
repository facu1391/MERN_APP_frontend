    ...
    <>
        ...
        <div className='mt-20 md:mt-50 shadow-lg px-5 py-10 rounded-xl bg-white'>
          ...
          <nav className="mt-10 lg:flex lg:justify-between">
              <Link className='block text-center my-5 text-gray-500' to="/">¿Ya tienes una cuenta? Inicia Secion</Link>
              <Link className='block text-center my-5 text-gray-500' to="/olvide-password">¿No tienes una cuenta? Registrate</Link>
          </nav>
        </div>
