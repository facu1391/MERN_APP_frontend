...
export const Formulario = () => {
  ...
  return (
    <>
      ...
      >
        <div className="mb-5">
            <label htmlFor="nombre" className="text-gray-700 uppercase font-bold">Nombre Paciente</label>
        ...
        <div className="mb-5">
            <label htmlFor="tutor" className="text-gray-700 uppercase font-bold">Nombre Tutor</label>
